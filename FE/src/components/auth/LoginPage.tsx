  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-6">
      <div className="w-full max-w-[440px] p-10 rounded-3xl border border-fog bg-white text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-midnight-ink text-white mb-6">
          <Mail size={32} />
        </div>
        <h1 className="text-[28px] font-[652] tracking-tight text-midnight-ink mb-1">EMAIL AUTOMATION</h1>
        <p className="text-sm text-graphite mb-10 leading-relaxed">
          Công cụ tối ưu hóa tiếp thị qua AWS SES và quản lý danh sách email nội bộ với độ trễ tối thiểu.
        </p>
